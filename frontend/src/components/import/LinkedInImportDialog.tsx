        ...
        {stage === 'upload' && (
          <>
            <p className="text-xs text-cream-500 mb-4 leading-relaxed">
              Export your LinkedIn data: <strong className="text-cream-300">Settings → Data Privacy → Get a copy of your data</strong> → select "Profile" → Request archive. Upload the JSON file here.
            </p>
            ...
            >
              ...
              <p className="text-sm text-cream-300">Drop your LinkedIn JSON file here</p>
              <p className="text-xs text-cream-500 mt-1">or click to browse</p>
            </div>
